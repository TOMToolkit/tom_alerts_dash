...
def create_alerce_alert(lastmjd=None, mean_magpsf_g=None, mean_magpsf_r=None, classrf=None, classearly=None,
                        pclassrf=None, pclassearly=None):
    return {'oid': fake.pystr_format(string_format='ZTF##???????', letters='abcdefghijklmnopqrstuvwxyz'),
            ...
            'classrf': classrf if classrf else fake.pystr(max_chars=10),
            'classearly': classearly if classearly else fake.pystr(max_chars=10),
